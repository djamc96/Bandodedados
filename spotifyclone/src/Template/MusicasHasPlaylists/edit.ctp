...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $musicasHasPlaylist->musicas_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $musicasHasPlaylist->musicas_id)]
            )
        ?></li>
...
<div class="musicasHasPlaylists form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Musicas Has Playlist') ?></legend>
        <?php
        ?>
    </fieldset>
